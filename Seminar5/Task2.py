...
total = 2021  # Сколько всего конфет
max_candy = 28  # максимально сколько можно взять конфет
print(f'На столе лежит {total} конфет. Играют два игрока делая ход друг после друга. Все конфеты достаются сделавшему последний ход.')
